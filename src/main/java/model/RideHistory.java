...
public class RideHistory implements Serializable {
    ...
    public String getDetailedInfo() {
        ...
        sb.append("Avaliação do Passageiro: ")
                .append(passengerRating > 0 ? passengerRating + " estrelas" : "Não avaliado").append("\n");
        sb.append("Avaliação do Motorista: ").append(driverRating > 0 ? driverRating + " estrelas" : "Não avaliado")
                .append("\n");
