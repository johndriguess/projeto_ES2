...
public class AuthServiceTest {
    ...
    public void shouldNotRegisterDuplicateEmail() throws Exception {
        ...
        ValidationException ex = assertThrows(ValidationException.class, () -> {
            auth.registerDriver("Johnatan", "sabrina@example.com", "82000000000", "senha123", "12345", "ABC-1234",
                    "Gol", 2018, "Prata");
        });
    ...
    public void shouldRegisterDriverWithInitialVehicle() throws Exception {
        Driver d = auth.registerDriver("Johnatan", "johnatan@ex.com", "82911112222", "senhadriver", "CNH123",
                "XYZ-9999", "Uno", 2018, "Branco");
    ...
    public void shouldAddVehicleToExistingDriver() throws Exception {
        auth.registerDriver("Existing Driver", "existing@ex.com", "111", "senha111", "123", "ABC-123", "Gol", 2018,
                "Prata");
    ...
    public void shouldNotRegisterDriverWithInvalidVehicle() {
        ValidationException ex = assertThrows(ValidationException.class, () -> {
            auth.registerDriver("Invalid", "invalid@ex.com", "12345", "senha_curta", "CNH123", "OLD-CAR", "Fusca", 1970,
                    "Azul");
        });
    ...
    public void shouldAssignUberBlackCategory() throws Exception {
        Driver d = auth.registerDriver("Luxury", "luxury@ex.com", "111", "senhaluxo", "CNH456", "LUX-0001", "Audi A6",
                2022, "preto");
        assertNotNull(d);
